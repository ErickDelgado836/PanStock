  ...
  return (
    <>
      <header className="bg-white border-b border-slate-200 sticky top-0 z-40 shadow-xs">
        ...
        <div className="bg-slate-900 text-slate-300 px-3 sm:px-4 py-1.5 text-xs flex flex-wrap items-center justify-between gap-1.5 sm:gap-2 border-b border-slate-800">
          ...
          <div className="flex items-center gap-2 sm:gap-4 text-[11px] sm:text-xs flex-wrap">
            ...
            {(() => {
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-1.5 px-2 sm:px-2.5 py-0.5 rounded-full text-[10px] sm:text-[11px] font-black border transition-all cursor-pointer ${
                    isConfigured
            ...
            <div className="flex items-center gap-1.5 text-slate-300 min-w-0">
              ...
              <span className="truncate max-w-[210px] sm:max-w-none text-[11px] sm:text-xs">
                Usuario: <strong className="text-white">{currentUser.username}</strong> ({currentUser.roleName})
              </span>
            </div>
          </div>
        </div>
