...
export const DEFAULT_TEAM_USERS: UserProfile[] = [
  ...
  },
  {
    ...
    permissions: {
      ...
      canSales: false,
      canPhysicalInventory: true,
      allowedWarehouses: ['00', '03', '05', '06', '07', '08', '09'],
    },
    createdAt: new Date().toISOString(),
  },
  {
    username: 'despacho',
    password: '123',
    roleName: 'Despacho de Mercancía',
    isAdmin: false,
    permissions: {
      canEntries: false,
      canExits: true,
